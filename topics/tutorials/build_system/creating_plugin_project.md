...
> New plugin projects should be implemented in a way that supports working in Remote Development mode or so-called [Split Mode](remote_development.md).
> Review [](remote_development.md) before settling on module boundaries.
>
