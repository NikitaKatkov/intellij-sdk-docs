...
For split plugins, perceived performance also depends on where feature logic runs.
...
An IDE working in Split Mode has separate frontend and backend processes that likely work on physically different machines.
